			    ...
			    <form class="well form-horizontal" method="post"  id="formulario" name="fRegistro">
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Teléfono</label>  
					    ...
					    <div class="input-group">
					      ...
					      <input name="telefono" id="telefono" class="form-control" type="text" placeholder="+593">
					    </div>
					  </div>
					</div>
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Sector</label>  
					    ...
					    <div class="input-group">
					        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
					  <input name="comuna" id="comuna" placeholder="Sector" class="form-control" type="text">
					    </div>
					  </div>
					</div>
